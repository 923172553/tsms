...
/**
 * Servlet implementation class Tb_Tax_PayerRenwu02
 */
@WebServlet("/Tb_Tax_PayerRenwu02.do")
public class Tb_Tax_PayerRenwu02 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Tb_Tax_PayerRenwu02() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Tb_Tax_PayerDaoImpl tstd = new Tb_Tax_PayerDaoImpl(); 
