					...
					<div class="lg-box">
						...
						<form method="post" id="form">
							...
							<div class="lg-check clearfix">
								...
								<span class="check-code"><img onclick="show()" id="captchaimg"
									src="LoginServlet.jpg" ></span>
							</div>
							...
							<div class="enter" align="center" >
								<input type="submit" class="supplier" id="d"  value="登录"/>
								<input type="reset" class="purchaser" id="c"  value="重置" />
...
$(function(){
	...
	captcha.src="LoginServlet.jpg?num="+Math.random();
