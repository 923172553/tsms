                   ...
                   <li>             	
                     ...
                     <li>
                        ...
                        <ul class="sider-nav-s">
                            <li class="active"><a href="javascript:addTab('任务查询','../../manage/jsp/searchTask.jsp?method=list')">调查任务查询</a></li>
                            <li><a href="javascript:addTab('调查任务录入','../../Tb_Tax_Source0201Servlet.do')">调查任务录入</a></li>
    ...
    $(function(){
    	...
    	$(".userInfo").on("click",function(){
    			$("#topWindow").window({
    				...
    				width:800,
    				height:300,
    				content:"<iframe scrolling='no' width='100%' height='100%' src='../../UserServlet.do?username=${username}'></iframe>"
    			})
    	})
